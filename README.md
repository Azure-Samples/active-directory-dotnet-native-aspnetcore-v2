...
- Other samples for Microsoft identity platform are available from [https://aka.ms/Microsoft Entra IDdevsamplesv2](https://aka.ms/Microsoft Entra IDdevsamplesv2).
- The conceptual documentation for MSAL.NET is available from [https://aka.ms/msalnet](https://aka.ms/msalnet).
- The documentation for identity platform is available from [https://aka.ms/Microsoft Entra IDv2](https://aka.ms/Microsoft Entra IDv2).
