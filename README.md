...
[4. Console app calls Web API - with PoP](https://github.com/Azure-Samples/active-directory-dotnet-native-aspnetcore-v2/tree/master/4.-Console-app-calls-web-API-with-PoP) | This part, presents the ASP.NET Core Web API protected by a Proof of Possession Authentication (Pop) token. This Web API is  exercised by a .NET Desktop console application. This subfolder contains a Visual Studio solution made of two applications: the desktop application (TodoListClient), and the Web API (TodoListService) </p> ![Topology](1.%20Desktop%20app%20calls%20Web%20API/ReadmeFiles/topology.png)
