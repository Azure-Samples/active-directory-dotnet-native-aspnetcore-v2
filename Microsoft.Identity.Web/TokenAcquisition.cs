...
namespace Microsoft.Identity.Web
{
    ...
    public class TokenAcquisition : ITokenAcquisition
    {
        ...
        /// for a downstream API using the token cache (for Web Apps and Web APis), or the 
        ...
        /// instance of the <paramref name="context"/> parameter
        /// </summary>
            ...
            string tenant = null)
        {
            ...
            // should work otherwise this might require a challenge
            // In the case Web APIs, the token cache key is a hash of the access token used to call the Web API
            JwtSecurityToken jwtSecurityToken = CurrentHttpContext.GetTokenUsedToCallWebAPI();
            string tokenCacheKey = (jwtSecurityToken != null) ? jwtSecurityToken.RawSignature
                                                              : CurrentHttpContext.User.GetMsalAccountId();
            CurrentHttpContext.SetTokenCacheKey(tokenCacheKey);
            ...
            catch(MsalUiRequiredException ex)
            {
                ...
                {
                    string tokenUsedToCallTheWebApi = jwtSecurityToken.InnerToken == null ? jwtSecurityToken.RawData
